...
def reset_seeds() -> None: #resetando sementes para reproduzir proprio treino do modelo
  """
...
url = 'raw.githubusercontent.com' #baixando dados de um repositorio
...
y = data["fetal_health"] #processar o dado
...
X_train, X_test, y_train, y_test = train_test_split(X_df, #definindo modelo
                                                    y,
                                                    test_size=0.3,
                                                    random_state=42)
...
mlflow.set_tracking_uri('https://dagshub.com/renansantosmendes/puc_lectures_mlops.mlflow') #após finalizar o treinamento, acessar esse link e registrar o modelo "fetal"
